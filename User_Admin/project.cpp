...
void displayFunctions()
{
    ...
    cout << "6. Launch Main Metro System (Metro.cpp)" << endl;
    
    cout << "-1. Add Stations( Developer Only)" << endl // pw - yes
         << endl;
...
A:
    ...
    case 5:
        ...
        break;
    case 6:
    cout << "\nCompiling and running Metro.cpp...\n";
    system("g++ Metro.cpp -o metro_exe && metro_exe");
    break;
